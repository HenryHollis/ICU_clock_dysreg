...
in_dir = "~/Documents/R/ClockCorr2/diff_expr_tables2/LFC_FDR_tables2/"
setwd(in_dir)
...
########Code for enriching ubiquitous lists as in fig 1c,d and fig2c, d#########3
#enriching the ubiquitous list:
ubiq_FDR = read.csv("ubiq_19_tissue_FDR_only_genes")
...
#############code for doing enrichment on individual tissues (supp fig 2)#########33
...
all_sig_genes_FDR = read.csv("all_sig_genes_FDR.csv", row.names = 1)
